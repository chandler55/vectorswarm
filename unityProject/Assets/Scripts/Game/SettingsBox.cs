...
public class SettingsBox : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Messenger.AddListener( Events.MenuEvents.TriggerSettingsMenu, OnTriggerSettingsMenu );
    ...
    void OnDestroy()
    {
        Messenger.RemoveListener( Events.MenuEvents.TriggerPauseMenu, OnTriggerSettingsMenu );
    }

    void OnTriggerSettingsMenu()
    {
        TriggerPauseMenu();
    }
